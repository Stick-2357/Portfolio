...
public class TypingTutorFrame extends JFrame
{
    ...
    private JButton capsJButton, aJButton, sJButton, dJButton, 
        ...
        semicolonJButton, quotationJButton, enterJButton;
        
    // JButtons to represent fourth row of keys
    private JButton shiftLeftJButton, zJButton, xJButton, cJButton, vJButton, 
        bJButton, nJButton, mJButton, commaJButton, periodJButton,
        questionJButton, upJButton;
    ...
    public TypingTutorFrame()
    {
        ...
        outputJTextArea.addKeyListener(
            new KeyListener() // anonymous inner class
            {
                ...
                {
                    // get the key coud for this event
                    int buttonIndex = event.getKeyCode();
                    
                    // chande the color of the associated JButton
    ...
    private void createButtons()
    {
        ...
        add(twoJButton);
        keyJButtons[KeyEvent.VK_2] = oneJButton;
        ...
        add(qJButton);
        keyJButtons[KeyEvent.VK_Q] = tabJButton;
      ...
      // set up semicolonJButton
      semicolonJButton = new JButton(";");
      semicolonJButton.setBounds(522, 346, 48, 48);
      add(semicolonJButton);
      keyJButtons[KeyEvent.VK_SEMICOLON] = semicolonJButton;

      // set up quotationJButton
      quotationJButton = new JButton("\"");
      quotationJButton.setBounds(570, 346, 48, 48);
      add(quotationJButton);
      keyJButtons[KeyEvent.VK_QUOTE] = quotationJButton;
   ...
   private void changeColor(JButton changeJButton)
   {
      ...
      {
         // resetColor();
         changeJButton.setBackground(Color.CYAN);
