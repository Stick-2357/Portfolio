...
class extPersonType : public personType {
	public:
		...
		void setInfo(string fName, string lName, int month, int day, int year, string street, string c, string s, string z, string phone,
			string pStatus);
		...
		extPersonType(string fName = "", string lName = "", int month = 1, int day = 1, int year = 1900, string street = "", string c = "", 
